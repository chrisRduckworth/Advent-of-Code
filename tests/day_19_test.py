from day_19 import get_info, eval_rule, eval_part, sum_accepted, find_new_range, total_possibilities
...
class TestTotalPossibilities:
    def test_returns_total_possibilities(self):
        system = """px{a<2006:qkq,m>2090:A,rfg}
pv{a>1716:R,A}
lnx{m>1548:A,A}
rfg{s<537:gd,x>2440:R,A}
...
{x=2127,m=1623,a=2188,s=1013}"""
        ...
        total = total_possibilities(rules)
